...
library Address{
    function sendValue(address payable recipient, uint256 amount) internal {
        require(address(this).balance >= amount, "Address: insufficient balance"); // balance check

        (bool success, ) = recipient.call{value: amount}("");
        require(success, "Address: unable to send value, recipient may have reverted"); // check revert
    }
}
...
contract VIRAL is ERC20, Ownable {
    ...
    address public treasuryWallet = 0x0000000000000000000000000000000; 
    address public devWallet = 0x0000000000000000000000000000000;
